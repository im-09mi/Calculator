...
<body>
    ...
    <form action="?" method="post">
        ...
        <table>
            <tr>
                <td><button type="submit" name="memory" value="store">M→</button></td>
                <td><button type="submit" name="memory" value="recall">MR</button></td>
                <td><button type="submit" name="memory" value="clear">MC</button></td>
            </tr>
            <tr>
